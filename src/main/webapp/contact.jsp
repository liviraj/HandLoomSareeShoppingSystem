                ...
                <div class="container px-5">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted mb-4">
                                                Contact us at
                                                <br />
                                                <a href="#!">loomcraftboutique@gmail.com</a>
                                                <br>
                                                <label>Mob & What'sApp : 9874563210</label>
                                                 <br>
                                                <label>LoomCraft Boutique,SH 68, Muthaiya Nagar, Thirupapuliyur, Cuddalore, Tamil Nadu 607002</label>
                                            </p>
                    ...
                    <div class="row gx-5 row-cols-2 row-cols-lg-4 py-5">
                        ...
                        <div class="col">
                            ...
                            <p class="text-muted mb-0">Browse our website and support articles to find solutions.</p>
                        </div>
                        <div class="col">
                            <div class="feature bg-primary bg-gradient text-white rounded-3 mb-3"><i class="bi bi-telephone"></i></div>
                            <div class="h5">Call us</div>
                            <p class="text-muted mb-0">Call us during normal business hours at (+91) 98745-63210.</p>
                        </div>
                    </div>
                </div>
            </section>
