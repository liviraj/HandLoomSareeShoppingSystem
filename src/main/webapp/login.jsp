                            ...
                            <div class="col-lg-8 col-xl-6">
                                <form action="LoginHomeController" method="post">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="uname" name="uname" type="text" placeholder="Enter your name..." required autofocus />
                                        <label for="name">User Name</label>
                                    </div>
                                    <!-- password input-->
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="psw" name="psw" type="password" placeholder="Enter your password" required />
